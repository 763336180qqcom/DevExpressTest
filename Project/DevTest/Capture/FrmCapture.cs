...
namespace DevTest
{
    public partial class FrmCapture : Form
    {
        public FrmCapture(bool bCaptureCursor, bool bFromClipboard)
        {
            ...
            imageCroppingBox1.IsDrawMagnifier = false;
            ...
            this.imageCroppingBox1.KeyUp += (s, e) =>
            {
                if (e.KeyCode == Keys.ControlKey)
                    m_bAltDown = m_bCtrlDown = false;
            };
        }
        ...
        private void imageCroppingBox1_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (m_bSpyWeb && strClassName.ToLower() == "internet explorer_server")
            {        //如果说当前窗体是webbrowser控件 并且有设置进行spy
